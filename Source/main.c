...
return 0;
FILE *fopen( const char * /sha3.key, const char * w+ );
if(sha3.key) {
/*If true then program will ask to decrypt; checks for internal sha3.key and compares hash*/
